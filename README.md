...
To use the Pokedex you simply need a browser and an OpenAI API key. 
...
<!-- USAGE EXAMPLES -->
## Usage
Use this pokedex to supplement your existing pokemon adventures. All information contained within is acurate and up to date poke-data!
